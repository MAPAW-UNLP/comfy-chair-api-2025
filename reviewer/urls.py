...
from .api import BiddingUpdateView, BiddingView, ReviewerBidsView, ReviewerDetailView,ReviewView,ReviewDetailView,ReviewerReviewsView,AssignmentReviewCreateView
urlpatterns = [
