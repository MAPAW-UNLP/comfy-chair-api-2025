...
from reviewer.serializers import ReviewerDetailSerializer,ArticleSerializer, BidSerializer, BidUpdateSerializer,ReviewSerializer,AssignmentReviewSerializer
